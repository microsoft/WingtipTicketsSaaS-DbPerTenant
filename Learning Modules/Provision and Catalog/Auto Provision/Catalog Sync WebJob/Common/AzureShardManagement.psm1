# Modifies the standard ShardManagement module with extended connection timeout for use with Azure. 
...
function New-ShardMapManager
{
    ...
    $SmmConnectionString = "Server=$SqlServerName; Initial Catalog=$SqlDatabaseName; User ID=$UserName; Password=$Password; Application Name = $AppName; Connection Timeout = 30;"
