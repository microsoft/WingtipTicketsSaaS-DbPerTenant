...
$recoveryCatalogServer = Get-AzureRmResource -ResourceGroupName $WingtipRecoveryResourceGroup -ResourceType "Microsoft.sql/servers" -Name $recoveryCatalogServerName
