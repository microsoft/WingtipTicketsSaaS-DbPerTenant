...
-- 
-- NOTE: DTU-levels are only accurate with a Basic or Standard edition database.
----------------------------------------------------------------------------------
...
BEGIN	
	...
	DECLARE @run_for_ms INT = 15 * 1000 * 
        (SELECT TOP 1 
            CASE WHEN @dtu_to_simulate >= dtu_limit THEN 1.0 ELSE (@dtu_to_simulate * 1.0 / dtu_limit) END 
